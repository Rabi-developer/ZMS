...
// Main component
const AdminSellingExp = () => {
  const [accounts, setAccounts] = useState<Account[]>([
    { id: '6', description: 'ADMIN & SELLING EXPENSES', children: [] },
  ]);
  ...
  const generateId = (parentId = '') => {
    if (!parentId) {
      ...
      return `${topLevelCount + 6}`; // Start IDs from 6
    } else {
      ...
      <div className="p-2 border-2 border-[#2aa0cd] shadow-2xl rounded">
        ...
        <div className="w-full bg-[#06b6d4] h-[7vh] rounded dark:bg-[#387fbf] mb-2 pt-2">
          <h1 className="text-base text-[24px] font-mono ml-10  pt-2 text-white flex gap-2">
            ...
            <span className="mt-1"> LIST OF ACCOUNT-ADMIN & SELLING EXPENSES </span>
          </h1>
        </div>
...
export default AdminSellingExp;