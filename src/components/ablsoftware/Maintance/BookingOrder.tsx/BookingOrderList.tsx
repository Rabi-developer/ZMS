...
// import { getAllBookingOrders, deleteBookingOrder, updateBookingOrderStatus } from '@/apis/bookingOrder';
// import { getAllConsignments, deleteConsignment } from '@/apis/consignment';
...
//     try {
//       setLoading(true);
//       const response = await getAllBookingOrders(pageIndex + 1, pageSize);
//       const orders = response?.data || [];
//       setBookingOrders(orders);

//       const consignmentsMap: { [orderId: string]: Consignment[] } = {};
//       for (const order of orders) {
//         const consRes = await getAllConsignments(1, 100, { orderNo: order.orderNo });
...
//       const response = await getAllConsignments(1, 100, { orderNo: order.orderNo });
...
//         'Status': index === 0 ? order.status || 'Pending' : '',
