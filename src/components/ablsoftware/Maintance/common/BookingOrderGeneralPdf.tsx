// File: src/components/ablsoftware/Maintance/common/BookingOrderGeneralPdf.tsx
'use client';
import jsPDF from "jspdf";
import autoTable from "jspdf-autotable";
import { RowData, ColumnKey } from "@/components/ablsoftware/Maintance/common/BookingOrderTypes";
...
export const exportGeneralBookingOrderToPDF = async (
  data: RowData[],
  ...
  doc.text(" GENERAL REPORT", pageWidth / 2, 98, { align: "center" });
  ...
  // Save the PDF
  const filename = `${COMPANY_NAME.replace(/\s+/g, "_")}_General_BookingOrder_Report.pdf`;
  doc.save(filename);
};