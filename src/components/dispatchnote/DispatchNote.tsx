...
const DispatchNote = () => {
  ...
  // Static options for Vehicle Type and Vehicle (replace with APIs if available)
  const vehicleTypes = [
    { id: '1', name: 'Truck' },
    { id: '2', name: 'Van' },
    { id: '3', name: 'Car' },
  ...
  const fetchContracts = async () => {
    try {
      setLoading(true);
      const response = await getAllContract(1, 100); // Fetch all contracts
  ...
  useEffect(() => {
    if (selectedSeller && selectedBuyer) {
      ...
      console.log('No Seller or Buyer selected, cleared filtered contracts');
    }
  }, [selectedSeller, selectedBuyer, contracts]);
  ...
  const handleContractSelect = (contract: ExtendedContract) => {
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <CustomInputDropdown
                ...
                onChange={(value) => {
                  ...
                  console.log('Selected Buyer:', value);
                }}
