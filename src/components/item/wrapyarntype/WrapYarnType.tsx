...
type WrapYarnTypeData = z.infer<typeof WrapYarnTypeSchema>;

const WrapYarnType = ({ isEdit = false }: { isEdit?: boolean }) => {
  ...
  const {
    ...
    formState: { errors },
    setValue,
  } = useForm<WrapYarnTypeData>({
    resolver: zodResolver(WrapYarnTypeSchema),
    defaultValues: {
      listid: '',
      descriptions: '',
      subDescription: '',
